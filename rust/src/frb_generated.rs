...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 521489591;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__read_metadata_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__read_metadata_batch_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
